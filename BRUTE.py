...
██      ██  ██████     ██    ██ ██   ██ ██   ██ ██   ██                                                                                                                                                                                                                                                                                                                       
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} LUTHFI XD             {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}LUTHFI XONTOL       {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}083861251898       {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}https://github.com/LuthfiXayorana{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}PREMIUM {P}     {N}      {H}     ║
   {H} ║{P}[{H}•{P}] Network   : {H}3G{N}, {H}4G/5G{N}, {H}ON{N}     {H}      ║
   {H} ║{P}[{H}•{P}] Version   : {H}2.0.9                 ║
   {H} ║{P}[{H}•{P}] Tools     : {H} Luthfi GREEN             ║
   {M} ╚════════════════════════════════════════╝ {P}""")
...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract Mehadi')
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/LuthfiXayorana");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/sipalinggantengEXE?mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}LUTHFI-XD {P}Terminal ');os.system("xdg-open https://www.facebook.com/sipalinggantengEXE?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://facebook.com/groups/409428564743139/');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://www.facebook.com/sipalinggantengEXE?mibextid=ZbWKwL");mainx()
def mainx2():
    os.system("clear")
    banner()
...
def sep():
    ...
    for k in range(limit):
        y += 1
        print(led);print(f'{dot}√ {P}[{H}100000077{P}] [{H}100000070{P}] [{H}100000010{P}] [{H}10000060{P}]\033[1;0m ');print(led);print(f'{dot}√[{H}10000085{P}] [{H}10000086{P}] [{H}10000089{P}] [{H}1000009{P}]\033[1;0m ');print(led)
